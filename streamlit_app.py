...
st.markdown(f"[{Інструкція з вивантаження файла з системи обліку товарів.}]({https://www.notion.so/utopiaunited/sdd-reconciliation-streamlit-app-76156c971a3940ac99eb0b56f0ef7456})", unsafe_allow_html=True)
